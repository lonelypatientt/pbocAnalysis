...
/**
 * FRePlloanId generated by hbm2java
 */
public class FRePlloanId implements java.io.Serializable {
	...
	public FRePlloanId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlloanId))
			return false;
		FRePlloanId castOther = (FRePlloanId) other;
