...
/**
 * FRePlaccfundId generated by hbm2java
 */
public class FRePlaccfundId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlaccfundId() {
	}

	public FRePlaccfundId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlaccfundId))
			return false;
		FRePlaccfundId castOther = (FRePlaccfundId) other;
