...
/**
 * FRePlcurraccountinfoId generated by hbm2java
 */
public class FRePlcurraccountinfoId implements java.io.Serializable {

	private String reportNo;
	private String uplevel;
	private int idenNo;

	public FRePlcurraccountinfoId() {
	}

	public FRePlcurraccountinfoId(String reportNo, String uplevel, int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlcurraccountinfoId))
			return false;
		FRePlcurraccountinfoId castOther = (FRePlcurraccountinfoId) other;
