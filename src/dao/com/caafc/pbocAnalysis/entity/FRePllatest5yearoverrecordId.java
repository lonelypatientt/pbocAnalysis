...
/**
 * FRePllatest5yearoverrecordId generated by hbm2java
 */
public class FRePllatest5yearoverrecordId implements java.io.Serializable {

	private String reportNo;
	private String uplevel;
	private int idenNo;

	public FRePllatest5yearoverrecordId() {
	}

	public FRePllatest5yearoverrecordId(String reportNo, String uplevel,
			int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePllatest5yearoverrecordId))
			return false;
		FRePllatest5yearoverrecordId castOther = (FRePllatest5yearoverrecordId) other;
