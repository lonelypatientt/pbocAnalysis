...
/**
 * FRePlrecorddetailId generated by hbm2java
 */
public class FRePlrecorddetailId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlrecorddetailId() {
	}

	public FRePlrecorddetailId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlrecorddetailId))
			return false;
		FRePlrecorddetailId castOther = (FRePlrecorddetailId) other;
