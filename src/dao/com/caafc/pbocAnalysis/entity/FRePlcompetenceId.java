...
/**
 * FRePlcompetenceId generated by hbm2java
 */
public class FRePlcompetenceId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlcompetenceId() {
	}

	public FRePlcompetenceId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlcompetenceId))
			return false;
		FRePlcompetenceId castOther = (FRePlcompetenceId) other;
