...
/**
 * FRePlstandardloancardId generated by hbm2java
 */
public class FRePlstandardloancardId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlstandardloancardId() {
	}

	public FRePlstandardloancardId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlstandardloancardId))
			return false;
		FRePlstandardloancardId castOther = (FRePlstandardloancardId) other;
