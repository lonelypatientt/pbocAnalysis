...
/**
 * FRePltelpaymentId generated by hbm2java
 */
public class FRePltelpaymentId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePltelpaymentId() {
	}

	public FRePltelpaymentId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePltelpaymentId))
			return false;
		FRePltelpaymentId castOther = (FRePltelpaymentId) other;
