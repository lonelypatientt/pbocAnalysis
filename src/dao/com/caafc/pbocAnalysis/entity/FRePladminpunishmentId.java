...
/**
 * FRePladminpunishmentId generated by hbm2java
 */
public class FRePladminpunishmentId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePladminpunishmentId() {
	}

	public FRePladminpunishmentId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePladminpunishmentId))
			return false;
		FRePladminpunishmentId castOther = (FRePladminpunishmentId) other;
