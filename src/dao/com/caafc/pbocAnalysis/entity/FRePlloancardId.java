...
/**
 * FRePlloancardId generated by hbm2java
 */
public class FRePlloancardId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlloancardId() {
	}

	public FRePlloancardId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlloancardId))
			return false;
		FRePlloancardId castOther = (FRePlloancardId) other;
