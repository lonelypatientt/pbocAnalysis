...
/**
 * FRePlcontractinfoId generated by hbm2java
 */
public class FRePlcontractinfoId implements java.io.Serializable {

	private String reportNo;
	private String uplevel;
	private int idenNo;

	public FRePlcontractinfoId() {
	}

	public FRePlcontractinfoId(String reportNo, String uplevel, int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlcontractinfoId))
			return false;
		FRePlcontractinfoId castOther = (FRePlcontractinfoId) other;
