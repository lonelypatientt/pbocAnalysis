...
/**
 * FRePlresidenceId generated by hbm2java
 */
public class FRePlresidenceId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlresidenceId() {
	}

	public FRePlresidenceId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlresidenceId))
			return false;
		FRePlresidenceId castOther = (FRePlresidenceId) other;
