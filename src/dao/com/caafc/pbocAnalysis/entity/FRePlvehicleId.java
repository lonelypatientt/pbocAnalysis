...
/**
 * FRePlvehicleId generated by hbm2java
 */
public class FRePlvehicleId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlvehicleId() {
	}

	public FRePlvehicleId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlvehicleId))
			return false;
		FRePlvehicleId castOther = (FRePlvehicleId) other;
