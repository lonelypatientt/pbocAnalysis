...
/**
 * FRePladminawardId generated by hbm2java
 */
public class FRePladminawardId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePladminawardId() {
	}

	public FRePladminawardId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePladminawardId))
			return false;
		FRePladminawardId castOther = (FRePladminawardId) other;
