...
/**
 * FRePlstateId generated by hbm2java
 */
public class FRePlstateId implements java.io.Serializable {
	...
	public FRePlstateId(String reportNo, String uplevel, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlstateId))
			return false;
		FRePlstateId castOther = (FRePlstateId) other;
