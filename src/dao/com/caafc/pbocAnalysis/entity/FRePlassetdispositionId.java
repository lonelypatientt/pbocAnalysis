...
/**
 * FRePlassetdispositionId generated by hbm2java
 */
public class FRePlassetdispositionId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlassetdispositionId() {
	}

	public FRePlassetdispositionId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlassetdispositionId))
			return false;
		FRePlassetdispositionId castOther = (FRePlassetdispositionId) other;
