...
/**
 * FRePlassurerrepayId generated by hbm2java
 */
public class FRePlassurerrepayId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlassurerrepayId() {
	}

	public FRePlassurerrepayId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlassurerrepayId))
			return false;
		FRePlassurerrepayId castOther = (FRePlassurerrepayId) other;
