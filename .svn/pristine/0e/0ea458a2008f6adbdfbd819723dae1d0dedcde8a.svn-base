...
/**
 * FRePlprofessionalId generated by hbm2java
 */
public class FRePlprofessionalId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlprofessionalId() {
	}

	public FRePlprofessionalId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlprofessionalId))
			return false;
		FRePlprofessionalId castOther = (FRePlprofessionalId) other;
