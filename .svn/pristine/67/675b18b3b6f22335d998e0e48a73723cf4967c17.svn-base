...
/**
 * FRePlendowmentdepositId generated by hbm2java
 */
public class FRePlendowmentdepositId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlendowmentdepositId() {
	}

	public FRePlendowmentdepositId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlendowmentdepositId))
			return false;
		FRePlendowmentdepositId castOther = (FRePlendowmentdepositId) other;
