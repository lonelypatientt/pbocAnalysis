...
/**
 * FRePlforceexecutionId generated by hbm2java
 */
public class FRePlforceexecutionId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlforceexecutionId() {
	}

	public FRePlforceexecutionId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlforceexecutionId))
			return false;
		FRePlforceexecutionId castOther = (FRePlforceexecutionId) other;
