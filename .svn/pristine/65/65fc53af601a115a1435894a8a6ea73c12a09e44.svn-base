...
/**
 * FRePlrecordsummaryId generated by hbm2java
 */
public class FRePlrecordsummaryId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlrecordsummaryId() {
	}

	public FRePlrecordsummaryId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlrecordsummaryId))
			return false;
		FRePlrecordsummaryId castOther = (FRePlrecordsummaryId) other;
