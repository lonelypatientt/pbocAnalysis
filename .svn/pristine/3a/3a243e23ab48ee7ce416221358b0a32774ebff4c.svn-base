...
/**
 * FRePlbankilluminateId generated by hbm2java
 */
public class FRePlbankilluminateId implements java.io.Serializable {
	...
	public FRePlbankilluminateId() {
	}

	public FRePlbankilluminateId(String reportNo, String uplevel, int serialNo,
			int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlbankilluminateId))
			return false;
		FRePlbankilluminateId castOther = (FRePlbankilluminateId) other;
