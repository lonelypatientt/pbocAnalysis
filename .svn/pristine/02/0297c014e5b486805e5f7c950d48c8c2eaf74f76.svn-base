...
/**
 * FRePlendowmentdeliverId generated by hbm2java
 */
public class FRePlendowmentdeliverId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePlendowmentdeliverId() {
	}

	public FRePlendowmentdeliverId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlendowmentdeliverId))
			return false;
		FRePlendowmentdeliverId castOther = (FRePlendowmentdeliverId) other;
