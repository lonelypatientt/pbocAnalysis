...
/**
 * FRePltaxarrearId generated by hbm2java
 */
public class FRePltaxarrearId implements java.io.Serializable {

	private String reportNo;
	private int serialNo;

	public FRePltaxarrearId() {
	}

	public FRePltaxarrearId(String reportNo, int serialNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePltaxarrearId))
			return false;
		FRePltaxarrearId castOther = (FRePltaxarrearId) other;
