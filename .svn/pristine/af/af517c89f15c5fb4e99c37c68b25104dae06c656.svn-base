...
/**
 * FRePlspecialtradeId generated by hbm2java
 */
public class FRePlspecialtradeId implements java.io.Serializable {
	...
	public FRePlspecialtradeId() {
	}

	public FRePlspecialtradeId(String reportNo, String uplevel, int serialNo,
			int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlspecialtradeId))
			return false;
		FRePlspecialtradeId castOther = (FRePlspecialtradeId) other;
