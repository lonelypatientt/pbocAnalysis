...
/**
 * FRePlawardcreditinfoId generated by hbm2java
 */
public class FRePlawardcreditinfoId implements java.io.Serializable {

	private String reportNo;
	private String uplevel;
	private int idenNo;

	public FRePlawardcreditinfoId() {
	}

	public FRePlawardcreditinfoId(String reportNo, String uplevel, int idenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FRePlawardcreditinfoId))
			return false;
		FRePlawardcreditinfoId castOther = (FRePlawardcreditinfoId) other;
