...
/**
 * FRePlundestoryloancard generated by hbm2java
 */
public class FRePlundestoryloancard implements java.io.Serializable {
	...
	public FRePlundestoryloancard() {
	}

	public FRePlundestoryloancard(String reportNo) {
		this.reportNo = reportNo;
	}

	public FRePlundestoryloancard(String reportNo, Long accountcount,
